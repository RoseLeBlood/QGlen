...
*/
QCLDevice::DeviceType QCLDevice::deviceType() const
{
    cl_device_type type;
    if (!m_id || clGetDeviceInfo(m_id, CL_DEVICE_TYPE, sizeof(type), &type, 0)
            != CL_SUCCESS)
        return QCLDevice::DeviceType::No;
    else
...
*/
QCLDevice::FloatCapability QCLDevice::floatCapabilities() const
{
...
/*!
    ...
    \sa hasDouble()
*/
QCLDevice::FloatCapability QCLDevice::doubleCapabilities() const
{
    cl_device_fp_config config;
...
/*!
    ...
    \sa hasHalfFloat()
*/
QCLDevice::FloatCapability QCLDevice::halfFloatCapabilities() const
{
    cl_device_fp_config config;
...
QList<QCLDevice> QCLDevice::devices
    (DeviceType types, const QCLPlatform &platform)
{
    QList<QCLDevice> devs;
