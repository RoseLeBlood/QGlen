...
public:
    ...
    QCLDevice::DeviceType deviceType() const;
    ...
    QCLDevice::FloatCapability floatCapabilities() const;
    QCLDevice::FloatCapability doubleCapabilities() const;
    QCLDevice::FloatCapability halfFloatCapabilities() const;
